       ...
       <el-carousel :interval="4000" type="card" height="200px"  @click="goToDetailsPage">
        ...
        <el-row class="recommend-products" >
          <el-col :span="8" v-for="(product, index) in products" :key="index">
            <el-col :span="23">
              <el-card shadow="hover" @click="goToDetailsPage(product.DeviceType.Type_Name)">
                <div class="product-card">
                  <img :src="product.DeviceType.Type_Name" alt="product image">
                  <div class="product-info">
                    <div class="product-name">{{ product.DeviceType.Type_Name }}</div>
