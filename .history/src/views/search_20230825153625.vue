      ...
      <div v-else>
        ...
        <el-row v-else class="recommend-products">
          <el-col :span="8" v-for="(device, index) in devices" :key="index">
            <el-col :span="23">
              <el-card shadow="hover" @click="goToDetailsPage(device.Device_Type_ID.Type_Name)">
                <div class="product-card">
                  <img :src="device.Device_Type_ID.Structure_Url[0]" alt="product image">
                  <div class="product-info">
                    <div class="product-name">{{ device.Device_Type_ID.Type_Name }}</div>
                  </div>
                </div>
              </el-card>
            </el-col>
